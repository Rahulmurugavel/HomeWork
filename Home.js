...
import bangles from "../assets/gold-bangles.jpg";
import earrings from "../assets/gold-earrings.jpg";
import rings from "../assets/gold-rings.jpg";
import neck from "../assets/gold-necklaces.jpg";
import homecss from "./Home.module.css";
import hr from "../assets/horizontal.svg";
import heroine from "../assets/heroine.jpg";
import pedant from "../assets/pedantset.jpg";
import stunningear from "../assets/stunningearrings.jpg";
import sleekrings from "../assets/sleekrings.jpg";
import coin from "../assets/silvercoin.jpg";
import bar from "../assets/bars.jpg";
import mangal from "../assets/mangal.jpg";
import coins from "../assets/coin.jpg";
import diamondbangle from "../assets/diamondbangle.jpg";
import noserings from "../assets/nosepins.jpg";
const Home = () => {
  return (
    <div>
      <header>
      ...
      <nav class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src={bangles} alt="bangle" type="button" className={homecss.posters}></img>
          </div>
          <div class="col-lg-6">
            <img src={neck} alt="necklace" type="button" className={homecss.posters}></img>
          </div>
        </div>
        <br></br>
        <div class="row">
          <div class="col-lg-6">
            <img src={earrings} alt="earrings" type="button" className={homecss.posters}></img>
          </div>
          <div class="col-lg-6">
            <img src={rings} alt="rings" type="button" className={homecss.posters}></img>
          </div>
        </div>
        <img src={hr}></img>
        ...
        <div class="row">
          <div class="col-lg-4">
            <img src={heroine} alt="actress" type="button" className={homecss.heroine}></img>
          </div>
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-12">
                <img src={pedant} alt="set" type="button" className={homecss.pedantset}></img>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                <img src={stunningear} alt="ear" type="button" className={homecss.ringsearrings}></img>
              </div>
              <div class="col-lg-6">
                <img src={sleekrings} alt="rings" type="button" className={homecss.ringsearrings}></img>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <img src={coin} alt="coin" type="button" className={homecss.poster}></img>
          </div>
          <div class="col-lg-4">
            <img src={bar} alt="bar" type="button" className={homecss.poster}></img>
          </div>
          <div class="col-lg-4">
            <img src={coins} alt="coins" type="button" className={homecss.poster}></img>
          </div>
        </div>
        <br></br>
        <div class="row">
          <div class="col-lg-4">
            <img src={noserings} alt="rings" type="button" className={homecss.poster}></img>
          </div>
          <div class="col-lg-4">
            <img src={diamondbangle} alt="bangle" type="button" className={homecss.poster}></img>
          </div>
          <div class="col-lg-4">
            <img src={mangal} alt="mangal" type="button" className={homecss.poster}></img>
          </div>
        </div>
      </nav>
      <br></br>
